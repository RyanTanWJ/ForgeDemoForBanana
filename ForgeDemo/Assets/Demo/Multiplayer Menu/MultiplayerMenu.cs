...
public class MultiplayerMenu : MonoBehaviour
{
    ...
    // New Code
    /// /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // This Creates a singlton of this script so we can reach it later through other scripts.
    public static MultiplayerMenu Instance;

    void Awake() {
        //this makes usre that the object that this is attached to lives over scene changes (Dont Destory On Load).
        GameObject[] GO = GameObject.FindGameObjectsWithTag(this.gameObject.tag);
        if (GO.Length > 1)
        {
        ...
        //This sets the static instance to this script creating the singleton.
        Instance = this;
    }

    //this disconnects any client or server that calls this from the current server.
    public void DisconnectFromServer()
    {
        //change back to multiplayer scene
        SceneManager.LoadScene(0);

        // ends the network session (not to sure if this is needed but it does not break anything)
        NetWorker.EndSession(); 
        if (server != null) server.Disconnect(true);

        // this is what cleans up the connection allowing you to host again.
        mgr.Disconnect();
    }

    // Everything else in this script is the same as the default forge multiplayer menu script.
    /// ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
